ServerEvents.recipes(event => {
    const transitional = 'sophisticatedstorage:copper_to_iron_tier_upgrade' // Making a constant to store the transitional item makes the code more readable
    event.recipes.create.sequenced_assembly(
        // Outputs:
        [
            CreateItem.of('sophisticatedstorage:iron_to_gold_tier_upgrade', 1.00), // Main output, will appear in JEI as the result
        ],
        // Input:
        ...
        [
            ...
            event.recipes.create.deploying(transitional, [transitional, 'minecraft:iron_ingot']),
